...
public class EditGUI extends JFrame implements ActionListener
{
    ...
    public EditGUI()
    {
        ...
        btnAddContact = new JButton("SAVE CHANGES");
    ...
    public void edit(Container pane)
    {
    ...
    public void set()
    {
        switch (Global.contactEdit)
        {
            case 0:
            {
                lblHeading.setText("edit contact #1");
            }
            break;
            case 1:
            {
                lblHeading.setText("edit contact #2");
            }
            break;
            case 2:
            {
                lblHeading.setText("edit contact #3");
            }
            break;
            case 3:
            {
                lblHeading.setText("edit contact #4");
            }
            break;
            case 4:
            {
                lblHeading.setText("edit contact #5");
            }
            break;
            default:
                break;
        ...
        txtName.setText(Global.contactList[Global.contactEdit][0]);
        txtNumber.setText(Global.contactList[Global.contactEdit][1]);
        txtNumberRetype.setText(Global.contactList[Global.contactEdit][1]);
    ...
    public boolean validation()
    {
        ...
        if (valid == true)
        {
            ...
            else
            {
                ...
                {
                    if ((number.equals(Global.contactList[i][1])) && (i != Global.contactEdit))
                    {
    ...
    public void actionPerformed(ActionEvent e)
    {
        switch (e.getActionCommand())
        {
            case "SAVE CHANGES":
            {
                if (validation() == true)
                {
                    Global.contactList[Global.contactEdit][0] = txtName.getText();
                    Global.contactList[Global.contactEdit][1] = txtNumber.getText();
                    Global.clearFrame();
